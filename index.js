...
saveButton.addEventListener("click", function getTextAndAddTodo() {
    ...
    todos.push(todotext, todos.length);
    addTodo(todotext);
    todoInputBar.value = '';
});
...
function addTodo(todoData, todoCount) {
    ...
    todoActions.classList.add("todo-actions", "d-flex", "justify-content-center", "gap-2");
    ...
    todoDetail.textContent = todoData; // sets the todo text sent from the input input
